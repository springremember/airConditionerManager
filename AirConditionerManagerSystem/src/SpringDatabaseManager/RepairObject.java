...
public class RepairObject implements DataManager<RepairObject> {
    ...
    public RepairObject(int repair_id,String dorm_id,String reason,boolean repair_status,int infor_status){
    ...
    public boolean repair_status;
    public int infor_status;
